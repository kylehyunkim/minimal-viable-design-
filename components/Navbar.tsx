...
const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <a
        href="#contact"
        className="px-4 py-2 md:px-6 bg-black text-white text-[10px] md:text-xs font-medium uppercase tracking-wider md:tracking-widest rounded-full hover:bg-gray-800 transition-colors"
      >
        Free Call
